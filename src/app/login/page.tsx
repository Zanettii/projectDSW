...
export default function Page() {
  ...
  return (
    <div className="flex h-screen m-0 p-0 bg-[var(--background)] text-[var(--primary)]">
      <style>styled</style>
          ...
          <form>
            <div className="mb-4">
              <input
                ...
                className="w-full p-2 rounded border border-gray-300 focus:outline-none focus:ring focus:ring-[var(--primary)]"
                required
              />
            </div>
            ...
            <button
              onClick={direcionar}
              type="submit"
              className="w-full py-3 bg-[var(--primary)] text-white rounded font-semibold hover:bg-opacity-90"
            >
              Entrar
            </button>
          </form>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-[var(--primary)] rounded-bl-md rounded-tl-md">
